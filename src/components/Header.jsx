  ...
  return (
    ...
    >
      ...
      <div>
        <a
          href="#contact"
          className="border border-[#5E43D5] py-1 px-5 rounded-md text-[#5E43D5] transform transition-all easy-in-out duration-200 hover:bg-[#5E43D5] hover:text-[#fff] cursor-pointer hidden sm:flex"
        >
          Contact
        </a>

        <button onClick={() => setOpenNav(!openNav)} className="flex sm:hidden">
